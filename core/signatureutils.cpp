...
QString Okular::errorString(SigningResult result, const QVariant &additionalMessage)
{
    ...
    case GenericSigningError:
        return i18nc("%1 is a file path", "Could not sign document. Could not write to '%1'", additionalMessage.toString());
    ...
    case SignatureWriteFailed:
        return i18nc("%1 is a file path", "Could not write signated document at '%1', please ensure you have selected a folder with write permission", additionalMessage.toString());
    }
