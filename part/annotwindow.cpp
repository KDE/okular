...
AnnotWindow::AnnotWindow(QWidget *parent, const QRect &initialViewportBounds, Okular::Annotation *annot, Okular::Document *document, int page)
...
void AnnotWindow::updateViewportBounds(const QRect &bounds)
{
