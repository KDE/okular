...
class AnnotWindow : public QFrame
{
    Q_OBJECT
public:
    AnnotWindow(QWidget *parent, const QRect &initialViewportBounds, Okular::Annotation *annot, Okular::Document *document, int page);
    ...
    void updateViewportBounds(const QRect &bounds);
