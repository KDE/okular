    ...
    if (nonDateValidCerts) {
        if (kleo.kleopatraIntegrationActive()) {
            auto result = KMessageBox::questionTwoActions(
                this, i18n("All your signing certificates are either not valid or are past their validity date"), i18n("No valid certificates"), KGuiItem(i18n("Open Certificate manager")), KStandardGuiItem::cancel());
        ...
        if (kleo.kleopatraIntegrationActive()) {
            auto result = KMessageBox::questionTwoActions(this,
                                                          i18n("There are no available signing certificates.<br/>Launch certificate manager to manager your certificates<br/>or for more information, please see the section about <a "
